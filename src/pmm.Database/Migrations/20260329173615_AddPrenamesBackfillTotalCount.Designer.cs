...
namespace Pmm.Database.Migrations
{
    ...
    [Migration("20260329173615_AddPrenamesBackfillTotalCount")]
    partial class AddPrenamesBackfillTotalCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pmm.Database.AppSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Pmm.Database.IndexerRowMatch", b =>
                {
                    ...
                    b.Property<Guid>("MatchedPreNameId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Pmm.Database.PrdbVideo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Pmm.Database.IndexerRowMatch", b =>
                {
                    ...
                    b.HasOne("Pmm.Database.PrdbVideoPreName", "MatchedPreName")
                        .WithMany()
                        .HasForeignKey("MatchedPreNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
